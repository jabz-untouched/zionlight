...
export default async function AboutPage() {
  ...
  return (
    <>
      ...
      <Section>
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <MotionDiv>
              <Card className="h-full p-8 bg-primary/5 border-primary/20">
            ...
            <MotionDiv delay={0.1}>
              <Card className="h-full p-8 bg-secondary/5 border-secondary/20">
          ...
          <Container>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <MotionDiv className="order-2 lg:order-1">
                ...
                <h3 className="text-xl text-primary font-medium mb-2">{director.name}</h3>
                <p className="text-muted-foreground mb-6">{director.role}</p>
                {director.bio && (
      ...
      {/* CTA Section */}
      <MotionSection className="py-20 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
